...
namespace zVirtual.Connect.Logging
{
    ...
    public class WindowsPhoneLogger<T> : ILog
    {
                private T type;
        ...
        {
            System.Diagnostics.Debug.WriteLine(string.Format("DEBUG ("+typeName+")  {0}    {1}",System.DateTime.Now, string.Format(format, args)));
        }
